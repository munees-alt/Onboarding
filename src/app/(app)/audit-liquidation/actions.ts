...
/** Create a new audit or liquidation case (an onboarding_run on the matching
 *  template). Team is assigned inside the case's first stage. AM+ only. */
export async function createAuditLiquidationCase(input: {
  clientId: string;
  flow: "audit" | "liquidation";
