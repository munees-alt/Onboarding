...
// Column mapping (verified against live schema):
// trade_licence_no, trade_licence_authority, phone, owner_name, primary_contact_email,
// industry, entity_type, vat_registered, name, business_description
...
for (const r of data) {
  ...
  if (r.licenseNumber) patch.trade_licence_no = r.licenseNumber;
  if (r.licenseAuthority) patch.trade_licence_authority = r.licenseAuthority;
  ...
  // licenseExpiry: no column found in schema, skip
