...
const T = {
  ...
  stages: [
    ...
    { id: "x3", name: "Client Portal Setup", desc: "Set up the document list, intake form, access requests and task board, create & share the Drive link, then dispatch the magic link.", steps: [
      ...
      { id: "x3.3", title: "Configure system access requests", kind: "person", who: ["Senior"], note: "Choose which systems the client must give us access to (FTA portal, bank, gateways, software…). Each gets a step-by-step SOP in the client portal.", act: { type: "access", btn: "Configure access requests" } },
      ...
      { id: "x3.6", title: "Dispatch magic link to client", kind: "link", who: ["System"], note: "Sends the magic link (+ Drive link). 7-day expiry.", act: { type: "dispatch", btn: "Dispatch magic link" } },
